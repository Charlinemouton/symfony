...
$a->setNamespace('sf_orm_default_a3d901f95c348fd1e301ed9f1ec2a99028796cba3d4aecbe2a98b9f66eb19457');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_a3d901f95c348fd1e301ed9f1ec2a99028796cba3d4aecbe2a98b9f66eb19457');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_a3d901f95c348fd1e301ed9f1ec2a99028796cba3d4aecbe2a98b9f66eb19457');

$d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), $this->getParameter('api_platform.resource_class_directories')), 'App\\Entity');
